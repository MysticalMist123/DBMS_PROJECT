...
async function insert(table_name,insert_values){
...
async function del(table_name,del_keys){
...
async function update(table_name,col,new_val,identifiers){
...
async function exec(sql_statement){
